...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('orders', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('paket_id')->nullable()->default(null)->change();
            $table->unsignedBigInteger('teknisi_id')->nullable()->default(null)->change();
         });
    }
    ...
    public function down(): void
    {
        Schema::table('orders', function (Blueprint $table) {
            ...
            $table->unsignedBigInteger('teknisi_id')->nullable(false)->change();
        });
    }
};
